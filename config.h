...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:size=12", "JoyPixels:size=12:antialias=true:autohint:true" };
...
static const Key keys[] = {
	...
	{ 0,														XF86XK_AudioRaiseVolume, spawn,   SHCMD("~/.config/dunst/dunstify_vol -i 10") },
	{ 0,														XF86XK_AudioLowerVolume, spawn,   SHCMD("~/.config/dunst/dunstify_vol -d 10") },
	{ 0,														XF86XK_MonBrightnessUp, spawn,    SHCMD("~/.config/dunst/dunstify_br -i") },
	{ 0,														XF86XK_MonBrightnessDown, spawn,  SHCMD("~/.config/dunst/dunstify_br -d") },
	...
	{ MODKEY|ControlMask|ShiftMask,	XK_s,			 spawn,          SHCMD("~/.local/bin/ss -s") },
	{ MODKEY,                       XK_v,      spawn,          SHCMD("~/.local/bin/sclip") },
	{ MODKEY,                       XK_p,      spawn,          SHCMD("~/.local/bin/passmenu") },
